...
public class FhirConnectConst {
    ...
    public static final List<String> OPENEHR_UNDERSCORABLES = Arrays.asList("health_care_facility", "end_time", "location", "participations"); // certain keywords are reserved and as such need to be prefixed with an underscore when constructing flat paths so ehrbase (un)marshaller can handle it
